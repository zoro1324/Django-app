...
from .forms import ContactDetail,RegisterForms,LoginForm
...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            user_data.save()
            messages.success(request,"You have successfully registered! Now you can Log in")
...
def forget_password(request):
    return render(request,"blog/forget_password.html",{'title':'Forget Password'})